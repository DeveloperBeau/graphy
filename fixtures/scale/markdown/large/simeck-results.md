...
Headline figures for Simeck from the latest nightly run, one line per
fleet machine in the store.

## Simeck headline figures
...
context see the [overview](simeck.md) and
[parameters](simeck-parameters.md) pages.
