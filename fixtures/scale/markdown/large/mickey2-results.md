...
Headline figures for MICKEY from the latest nightly run, one line per
fleet machine in the store.

## MICKEY headline figures
...
context see the [overview](mickey2.md) and
[parameters](mickey2-parameters.md) pages.
