...
Headline figures for Camellia from the latest nightly run, one line per
fleet machine in the store.

## Camellia headline figures
...
context see the [overview](camellia.md) and
[parameters](camellia-parameters.md) pages.
