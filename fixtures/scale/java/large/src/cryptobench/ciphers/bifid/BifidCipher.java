...
public class BifidCipher implements Cipher {
    private final PolybiusCipher coordinates;

    public BifidCipher(BifidKey key) { this.coordinates = new PolybiusCipher(new PolybiusKey(key.getSeedWord())); }

    @Override
    public String name() { return "bifid"; }
