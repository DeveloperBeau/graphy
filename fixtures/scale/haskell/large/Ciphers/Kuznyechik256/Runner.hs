module Ciphers.Kuznyechik256.Runner (runCase, label) where

import Ciphers.Kuznyechik256.Impl (decrypt, encrypt)
import Ciphers.Kuznyechik256.Model (keyBits, name)
